...
{
  private:
    vector<string>* names; vector<double>* values; vector<string>* paths; // store all parameter names and values
  ...
  public:
    ...
    void setPath(string name, string path); // set the parameter with "name" to path "path"
    double getVal(string name); // return the value for parameter with "name"
    string getPath(string name); // return the path for the parameter with "name"
